  ...
  return (
    <div className="relative h-dvh w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center">
        <div className="grid h-full content-between">
          <div>
            ...
            >
              <p className="text-center text-5xl font-[700] tracking-tight text-[#FFF662]">
                16 MAY
              </p>
          ...
          <div>
            ...
            />
            <div
              className={`${gluten.className} m-auto w-fit rounded-t-lg bg-[#C22B00]/50 p-4 text-white backdrop-blur-sm drop-shadow-lg`}
            >
      ...
      >
        ...
        >
          <div>
            <MapPin className="m-auto h-10 w-10 text-[#BA2800]/90" />
            <p className="m-auto font-[700] text-[#BA2800]/70">Ubicación</p>
          </div>
        </button>
      </div>
        ...
        <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/60 px-6">
          <div className="relative w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <p className="text-center leading-relaxed text-gray-700">
              ...
              pero si quieres tener un detalle puedes traer pañales Winnie etapa{" "}
        ...
        <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/60 px-6">
          <div className="relative w-full max-w-sm rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <button
              ...
              className="mb-3 w-full rounded-xl bg-[#0119B9] p-3 text-white"
            >
            ...
            <button
              ...
              className="w-full rounded-xl bg-[#05C8F7] p-3 text-black"
            >
              Abrir en Waze
            </button>
          </div>
